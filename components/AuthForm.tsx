    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isLoginMode) {
                ...
                if (existingUser) {
                    throw new Error('Já existe uma conta com este email. Por favor, faça login.');
                }
            ...
            >
                ...
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-5xl font-black mb-4 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
                        {isLoginMode ? 'Bem-vindo de Volta' : 'Comece Hoje'}
                    </h2>
                    <p className="text-xl text-gray-400">
                        {isLoginMode ? 'Digite suas credenciais para acessar seu painel' : 'Crie sua conta e desbloqueie seu painel personalizado'}
                    </p>
                </div>
