...
const pricingPlans = [
  {
    ...
    price: "Gratis",
    features: [
      "Acesso a plataforma EAI",
      "Jogos educativos basicos",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-24">
          ...
          <p className="text-[#99A1AF] text-xl font-light max-w-2xl mx-auto px-6 md:px-0">
            Planos transparentes para cada momento da sua jornada.
          </p>
        </div>
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className="mb-10 flex items-baseline gap-1">
                {plan.price !== "Gratis" && <span className="text-sm align-top text-[#99A1AF]">R$</span>}
                <span className="text-5xl font-black tracking-tight">{plan.price}</span>
                {plan.price !== "Gratis" && <span className="text-sm text-[#99A1AF]">/mes</span>}
              </div>
